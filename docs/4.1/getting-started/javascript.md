...
Plugins can be included individually (using Bootstrap's individual `js/dist/*.js` files), or all at once using `bootstrap.js` or the minified `bootstrap.min.js` (don't include both).
